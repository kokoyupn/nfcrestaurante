...
public class GeneralRestaurantes extends Activity {
			...
			public void onItemClick(AdapterView<?> arg0, View vista,int posicion, long id){
  	    		if (!comparando){
		  	    	// Iniciamos la nueva actividad y le pasamos los datos del restaurante
	  	  			...
	  	  			restaurantes.get(posicion).setSelected(!restaurantes.get(posicion).isSelected());
		  	  		adapterListGeneralRestaurantes = new MiListGeneralRestaurantesAdapter(GeneralRestaurantes.this, restaurantes);
					listViewRestaurantes.setAdapter(adapterListGeneralRestaurantes);
	  	  		}
  	    	}
	...
	public ArrayList<PadreListRestaurantes> obtenerRestaurantes() {
		...
		restaurantes.add(new PadreListRestaurantes("Vips Princesa",8,"Calle de la Princesa 5", "28008", "Madrid", "vips", "vips_princesa5", "+34912752063", 4));
		restaurantes.add(new PadreListRestaurantes("Vips Princesa2",9,"Calle de la Princesa 3", "28008", "Madrid", "vips", "vips_princesa5", "+34912752064", 3));
		restaurantes.add(new PadreListRestaurantes("Vips Goya",10,"Calle Goya 67", "28020", "Madrid", "vips", "vips_goya67", "+34912752213", 4));
		restaurantes.add(new PadreListRestaurantes("Vips Goya",11,"Calle Goya 67", "28020", "Madrid", "vips", "vips_goya67", "+34912752213", 4));
		restaurantes.add(new PadreListRestaurantes("Vips Goya",12,"Calle Goya 67", "28020", "Madrid", "vips", "vips_goya67", "+34912752213", 4));
		restaurantes.add(new PadreListRestaurantes("Vips Goya",13,"Calle Goya 67", "28020", "Madrid", "vips", "vips_goya67", "+34912752213", 4));
		restaurantes.add(new PadreListRestaurantes("Vips Goya",14,"Calle Goya 67", "28020", "Madrid", "vips", "vips_goya67", "+34912752213", 4));
